...
fun calculateCommission(paymentType: String = "VkPay", previousTransactions: Int = 0, amount: Int): Double {
    ...
    ) amount * 0.6 / 100 + 20 else (amount * paymentTypeCommission(paymentType) / 100)
    return if (commissionAmount < VisaMinCommission && paymentType == "Мир" || paymentType == "Visa") VisaMinCommission else commissionAmount
